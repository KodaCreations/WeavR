...
public class ControlSchemes {
    ...
    {
        return new KeyCode[] { player1Forward, player1Backward, player1Left, player1Right, player1Boost };
    }
    public static KeyCode[] GetScheme2()
    {
        return new KeyCode[] { player2Forward, player2Backward, player2Left, player2Right, player2Boost };
    }
}
