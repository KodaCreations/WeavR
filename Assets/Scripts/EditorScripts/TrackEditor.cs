...
public class TrackEditor : MonoBehaviour {
    ...
    void SaveMesh()
    {
        ...
        AssetDatabase.CreateAsset(road.GetComponent<MeshFilter>().sharedMesh, "Assets/Prefabs/Tracks/TrackAssets/" + name + whatName + ".asset");
        ...
        PrefabUtility.CreatePrefab("Assets/Prefabs/Tracks/AutoGeneratedTracks/" + name + whatName + ".prefab", road);
