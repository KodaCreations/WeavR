...
public class TrackEditor : MonoBehaviour {
    ...
    void PlaceSegmentsOnSpline(float startTime)
    {
        ...
        for (int i = 0; i < segmentVertices.Count; ++i)
        {
            ...
            {
                //StartCoroutine(DrawVertex(0, segmentVertices[i][j]));
            }
        }
        UpdateMeshToSpline();
    }
    ...
    void SaveMesh()
    {
...
#if UNITY_EDITOR
        UnityEditor.AssetDatabase.CreateAsset(road.GetComponent<MeshFilter>().sharedMesh, "Assets/Prefabs/Tracks/TrackAssets/" + name + whatName + ".asset");
        ...
        UnityEditor.PrefabUtility.CreatePrefab("Assets/Prefabs/Tracks/AutoGeneratedTracks/" + name + whatName + ".prefab", road);
#endif
    }
