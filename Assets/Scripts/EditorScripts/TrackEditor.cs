...
public class TrackEditor : MonoBehaviour {
    ...
    void SaveMesh()
    {
        ...
        UnityEditor.PrefabUtility.CreatePrefab("Assets/Prefabs/Tracks/AutoGeneratedTracks/" + name + whatName + UnityEngine.SceneManagement.SceneManager.GetActiveScene().name + ".prefab", road);
#endif
    }
